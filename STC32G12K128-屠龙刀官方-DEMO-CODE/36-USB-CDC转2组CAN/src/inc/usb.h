...
//#define printf  printf_cdc1
//#define printf  printf_cdc2
...
extern BYTE CDC1OutNumber;
extern BYTE CDC2OutNumber;

extern BYTE xdata CDC1InBuffer[64];
extern BYTE xdata CDC1OutBuffer[64];
extern BOOL bCDC1InBusy;
extern BOOL bCDC1OutReady;

extern BYTE xdata CDC2InBuffer[64];
extern BYTE xdata CDC2OutBuffer[64];
extern BOOL bCDC2InBusy;
extern BOOL bCDC2OutReady;
