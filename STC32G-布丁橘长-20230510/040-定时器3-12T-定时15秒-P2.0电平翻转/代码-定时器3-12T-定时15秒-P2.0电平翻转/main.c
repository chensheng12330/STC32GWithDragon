//		@布丁橘长 2022/11/17
//		定时器3-12T模式-16位自动重装载：定时15秒，每15秒翻转一次P2.0电平
...
void Timer3_Init(void);		//15秒@12.000MHz  定时器3初始化函数声明
...
void Timer3_Init(void)		//15秒@12.000MHz
{
	TM3PS = 0xE4;			//设置定时器时钟预分频 ( 注意:并非所有系列都有此寄存器,详情请查看数据手册 )
