...
void main(void)
{
	...
	P1IM1 = 0x00;P1IM0 = 0x00;	// P1.1设置为下降沿触发
// 	P1IM1 = 0x00;P1IM0 = 0x02;	// P1.1设置为上升沿触发
//	P1IM1 = 0x02;P1IM0 = 0x00;	// P1.1设置为低电平触发
//	P1IM1 = 0x02;P1IM0 = 0x02;	// P1.1设置为高电平触发
	
	P1INTE = 0x02;							// 使能P1.1口中断
...
/*
		if (intf & 0x04)	//P1.2 口中断
		{
		
		}
		if (intf & 0x08)	//P1.3 口中断
		{
		
		}
		if (intf & 0x10)	//P1.4 口中断
		{
