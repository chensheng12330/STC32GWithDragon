//	@布丁橘长 2023/03/03
//	PWMA互补输出示例，PWM1P、PWM1N（P1.0、P1.1）输出一组带死区互补对称波形，周期200us,占空比50%,死区10us
...
#define PWM_DTime		120				//死区10us
//#define PWM_DTime		185			//死区20us
//#define PWM_DTime		220			//死区40us
//#define PWM_DTime		238			//死区60us
