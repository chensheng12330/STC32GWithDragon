...
//	P2口流水灯完成后，LED熄灭，进入空闲模式，P3.1 IO口中断唤醒，唤醒后，P2口循环流水灯
...
void main(void)
{
	...
	P3IM1 = 0x00;P3IM0 = 0x00;	// P3.1设置为下降沿中断
// 	P3IM1 = 0x00;P3IM0 = 0x02;	// P3.1设置为上升沿中断
//	P3IM1 = 0x02;P3IM0 = 0x00;	// P3.1设置为低电平中断
//	P3IM1 = 0x02;P3IM0 = 0x02;	// P3.1设置为高电平中断
	
	P3INTE = 0x02;							// 使能P3.1口中断
