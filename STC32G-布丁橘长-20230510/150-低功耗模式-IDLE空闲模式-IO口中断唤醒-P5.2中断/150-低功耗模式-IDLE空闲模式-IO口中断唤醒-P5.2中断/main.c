...
//	P2口流水灯完成后，LED熄灭，进入空闲模式，P5.2 IO口中断唤醒，唤醒后，P2口循环流水灯
...
void main(void)
{
	...
	P5IM1 = 0x00;P5IM0 = 0x00;	// P5.2设置为下降沿中断
// 	P5IM1 = 0x00;P5IM0 = 0x04;	// P5.2设置为上升沿中断
//	P5IM1 = 0x04;P5IM0 = 0x00;	// P5.2设置为低电平中断
//	P5IM1 = 0x04;P5IM0 = 0x04;	// P5.2设置为高电平中断
	
	P5INTE = 0x04;							// 使能P5.2口中断
