...
//		A-DP接初级595输出Y0-Y7，COM1接P0.3，COM2接P0.2，COM3接P0.1，COM4接P0.0
...
void main()
{
	...
	while(1)
	{
		...
		{
			Write595(2);							//显示2
			COM1 = 0;COM2	= 1;COM3 = 1;COM4 =1;			//共阴极数码管，公共端给低电平点亮，点亮数码管左起第1位
			delayms(1);															//延时1毫秒
			
			Write595(0);							//显示0
			COM1 = 1;COM2	= 0;COM3 = 1;COM4 =1;			//共阴极数码管，公共端给低电平点亮，点亮数码管左起第2位
			delayms(1);															//延时1毫秒
			
			Write595(2);							//显示2
			COM1 = 1;COM2	= 1;COM3 = 0;COM4 =1;			//共阴极数码管，公共端给低电平点亮，点亮数码管左起第3位
			delayms(1);															//延时1毫秒
			
			Write595(3);							//显示3
			COM1 = 1;COM2	= 1;COM3 = 1;COM4 =0;			//共阴极数码管，公共端给低电平点亮，点亮数码管左起第4位
			delayms(1);															//延时1毫秒
		}
	}
}
