//		@布丁橘长 2023/02/14
//		多功能按键-定时器版-状态机-长按、短按、双击
//		占用定时器4，需要在主函数中对定时器4初始化：Timer4_Init();并使能EA=1
